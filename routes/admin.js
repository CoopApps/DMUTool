...
router.get('/', (req, res) => {
  ...
  const SOURCES = ['hansard','writtenQuestions','committees','govuk','whatson','feeds','guardian','thinktanks','briefings','appgs','alliance','bills','petitions','legislation','edms','oralQuestions','contensis','staffXml','dmuEvents','ukri','commonsRefresh','lordsRefresh','mpRefresh','email','briefing'];
  const logBySource = {};
