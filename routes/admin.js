...
router.get('/', (req, res) => {
  ...
  const SOURCES = ['hansard','writtenQuestions','committees','govuk','whatson','feeds','guardian','thinktanks','briefings','appgs','bills','petitions','legislation','edms','oralQuestions','contensis','staffXml','dmuEvents','mpRefresh','email','briefing'];
  const logBySource = {};
