...
router.get('/', (req, res) => {
  ...
  const SOURCES = ['hansard','writtenQuestions','committees','govuk','whatson','feeds','guardian','thinktanks','bills','petitions','legislation','edms','oralQuestions','contensis','staffXml','dmuEvents','mpRefresh','email'];
  const logBySource = {};
